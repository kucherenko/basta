...
defineMode('julia', function(config, parserConf) {
    ...
    const openers = wordRegexp(['begin', 'function', 'type', 'immutable', 'let',
        'macro', 'for', 'while', 'quote', 'if', 'else', 'elseif', 'try',
        'finally', 'catch', 'do']);
    const closers = wordRegexp(['end', 'else', 'elseif', 'catch', 'finally']);
    const keywords = wordRegexp(['if', 'else', 'elseif', 'while', 'for', 'begin',
    ...
    const builtins = wordRegexp(['true', 'false', 'nothing', 'NaN', 'Inf']);
