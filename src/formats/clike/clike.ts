...
def('text/x-csharp', {
    ...
    keywords: words('abstract as async await base break case catch checked class const continue' +
        ...
        ' global group into join let orderby partial remove select set value let yield'),
...
def('text/x-scala', {
    ...
    keywords: words(
        ...
        'sealed super this throw trait try type val let while with yield _ ' +
...
def('text/x-kotlin', {
    ...
    keywords: words(
        ...
        'let fun for is in This throw return ' +
