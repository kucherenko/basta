...
defineMode('crystal', function(config) {
    ...
    const atomWords = wordRegExp(['true', 'false', 'nil', 'self'], undefined);
    const indentKeywordsArray = [
        'def', 'fun', 'macro',
        'class', 'module', 'struct', 'lib', 'enum', 'union',
        'do', 'for'
    ];
    const indentKeywords = wordRegExp(indentKeywordsArray, undefined);
    const indentExpressionKeywordsArray = ['if', 'unless', 'case', 'while', 'until', 'begin', 'then'];
    const indentExpressionKeywords = wordRegExp(indentExpressionKeywordsArray, undefined);
    const dedentKeywordsArray = ['end', 'else', 'elsif', 'rescue', 'ensure'];
    const dedentKeywords = wordRegExp(dedentKeywordsArray, undefined);
...
defineMIME('text/x-crystal', 'crystal');
