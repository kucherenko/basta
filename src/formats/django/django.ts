...
defineMode('django:inner', function() {
    let keywords: any = ['block', 'endblock', 'for', 'endfor', 'true', 'false', 'filter', 'endfilter',
        ...
        filters: any = ['add', 'addslashes', 'capfirst', 'center', 'cut', 'date',
        ...
        operators: any = ['==', '!=', '<', '>', '<=', '>='],
        wordOperators: any = ['in', 'not', 'or', 'and'];
...
defineMode('django', function(config) {
...
defineMIME('text/x-django', 'django');
