...
defineMode('rst', function(config, options) {
    ...
    return overlayMode(mode, overlay, true); // combine
}, 'python', 'stex');

///////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////

defineMode('rst-base', function(config) {
    ...
    const mode_python = getMode(config, 'python');
    const mode_stex = getMode(config, 'stex');
    ...
    function to_normal(stream, state) {
        ...
        if (stream.sol() && stream.match(rx_examples, false)) {
            change(state, to_mode, {
                mode: mode_python, local: startState(mode_python)
            });
            ...
            switch (stage(state)) {
                ...
                case 3:
                    if (state.tmp_stex) {
                        ...
                        state.tmp = {
                            mode: mode_stex, local: startState(mode_stex)
                        };
                    }
