...
defineMode('clojure', function(options) {
    ...
    const keywords = makeKeywords(
        ...
        'slice defalias defhinted defmacro- defn-memo defnk defnk defonce- defunbound defunbound- deflet defvar- let letfn ' +
    ...
    const builtins = makeKeywords(
        ...
        'find-ns find-protocol-impl find-protocol-method find-let first flatten float float-array float? floats flush fn fn? ' +
...
defineMIME('text/x-clojure', 'clojure');
defineMIME('text/x-clojurescript', 'clojure');
defineMIME('application/edn', 'clojure');
